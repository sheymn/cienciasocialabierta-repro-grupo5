...
- Procesamiento de datos: Se encuentra en el archivo `processing/prod_prep.Rmd` dentro del repositorio del proyecto. En este archivo se incluye el código de procesamiento y análisis realizado por el equipo para intentar reproducir los resultados del artículo.
